...
DNS:
apim-tester.azure-api.net → private IP
```
...
```text
1. Can workload resolve APIM hostname privately?
2. Can APIM reach Function?
3. Can Function reach Logic App?
4. Can Logic App reach Storage?
5. Does Storage resolve to Private Endpoint?
6. Is Logic App using built-in Blob connector?
7. Is Blob action Content populated?
8. Is Logic App VNet Integration enabled?
9. Are NSGs blocking TCP 443?
10. Are UDRs forcing traffic through an NVA?
11. Is custom DNS forwarding correct?
12. Is public Storage access disabled?
13. Does re-enabling Storage public access immediately make it work?
```
